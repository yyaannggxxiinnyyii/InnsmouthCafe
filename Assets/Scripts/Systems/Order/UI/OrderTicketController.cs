...
namespace InnsmouthCafe.UI
{
    ...
    public class OrderTicketController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                _orderTicketUI.OnDetailShown += OnDetailShown;
                _orderTicketUI.OnThumbnailShown += OnThumbnailShown;
            }
        }
        ...
        private void OnOrderGenerated(OrderSO order)
        {
            ...
            _orderTicketUI.gameObject.SetActive(true);
