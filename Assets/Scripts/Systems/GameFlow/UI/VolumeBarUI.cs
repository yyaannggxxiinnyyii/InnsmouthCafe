...
namespace InnsmouthCafe.UI
{
    ...
    public class VolumeBarUI : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("倒液量文本背景的CanvasGroup（控制显隐）")]
        private CanvasGroup _liquidVolumeCanvasGroup;
        ...
        private void Awake()
        {
            ...
            if (_liquidVolumeCanvasGroup != null)
            {
                _liquidVolumeCanvasGroup.alpha          = 0f;
                _liquidVolumeCanvasGroup.blocksRaycasts = false;
            }
        }
        ...
        private void Start()
        {
            ...
            if (_manager != null)
            {
                ...
                _manager.OnPouringChanged += OnPouringChanged;
            }
        }
        ...
        /// <summary>
        /// 倒液状态变化回调（开始倒液时 liquid 不为 null，停止时为 null）
        /// </summary>
        private void OnPouringChanged(LiquidSO liquid)
        {
            SetLiquidVolumeVisible(liquid != null);
        }
        ...
        {
            if (_currentLiquidVolumeText == null && _liquidVolumeCanvasGroup == null) return;

            LiquidSO pouring = _manager?.CurrentPouringLiquid;
            if (pouring == null)
            {
                SetLiquidVolumeVisible(false);
                return;
            }
        ...
        /// 控制倒液量文本背景的显隐
        /// </summary>
        private void SetLiquidVolumeVisible(bool visible)
        {
            if (_liquidVolumeCanvasGroup != null)
            {
                _liquidVolumeCanvasGroup.alpha          = visible ? 1f : 0f;
                _liquidVolumeCanvasGroup.blocksRaycasts = visible;
            }
        }
